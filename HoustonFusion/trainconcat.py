...
class GAN():
    def __init__(self):
        ...
        self.classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/HoustonFusion/twostreamconcat.h5')
    ...
    def train(self, epochs, batch_size=128):
        ...
        X_train, Houston_Fusion_gt = loadData()
        #print(X_train)
        ...
        X_train, Y = createPatches(X_train, Houston_Fusion_gt, windowSize=3, removeZeroLabels=False)
        ...
        for epoch in range(epochs):
            ...
            for g in range(5):
                ...
                if epoch >= epochs/2:
                    self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/HoustonFusion/models/generator-{0}.h5'.format(epoch))
                    self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/HoustonFusion/models/discriminator-{0}.h5'.format(epoch))
