...
classifier = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/Average/twostreamdistillationaverage.h5')
...
generator = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/Average/generatoraverage.h5')
#generator = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/2N/generator2N.h5')
                                         #latent, conditional
...
(generated_images_train, generated_images_test,Ytrain_indian_pine,Ytest_indian_pines,) = train_test_split(generated_images,Y, random_state = 666)
(secondstream_train, secondstream_test,Ytrain_indian_pine,Ytest_indian_pines,) = train_test_split(data2,Y, random_state = 666)
(firststream_train, firststream_test,Ytrain_indian_pine,Ytest_indian_pines,) = train_test_split(data1,Y, random_state = 666)
...
results = finalclassifier.evaluate([firststream_test,secondstream_test],Ytest_indian_pines, batch_size=32)
results1 = finalclassifier.evaluate([generated_images_test,secondstream_test],Ytest_indian_pines, batch_size=32)

print(" ")
print('REAL DATA %d test loss, test acc:', results)
print('GENERATED DATA test loss, test acc:', results1)
