...
class GAN():
    def __init__(self):
        ...
        self.classifier = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/Average/twostreamdistillationaverage.h5')
    ...
    def train(self, epochs, batch_size=128):
        ...
        for epoch in range(epochs):
            ...
            for g in range(5):
                ...
                #if epoch >= epochs/2:
                self.generator.save('/home/SharedData/Avinandan/Semi Supervised GAN/Average/models/generator2N-{0}.h5'.format(epoch))
                self.discriminator.save('/home/SharedData/Avinandan/Semi Supervised GAN/Average/models/discriminator2N-{0}.h5'.format(epoch))
