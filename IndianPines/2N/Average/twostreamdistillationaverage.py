...
classifier1= Dense(16,activation='softmax', name='Classifier_Output_1')(classifier1)

classifier2 = Lambda(lambda x: x / 2)(classifier2)
classifier2= Dense(16,activation='softmax', name='Classifier_Output_2')(classifier2)

classifierfinal = Average()([classifier1,classifier2])

#modelone = Model(inputs=modelinput1, outputs=classifier1)
#modeltwo = Model(inputs=modelinput2, outputs=classifier2)
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/Semi Supervised GAN/Average/twostreamdistillationaverage.h5', monitor='val_acc', verbose=1
...
#model.save('/home/SharedData/Avinandan/Semi Supervised GAN/Average/twostreamdistillation.h5')
