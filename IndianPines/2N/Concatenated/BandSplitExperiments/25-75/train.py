...
class GAN():
    def __init__(self):
        ...
        self.classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/25-75/twostream.h5')
        ...
        for epoch in range(epochs):
            ...
            for g in range(5):
                ...
                if epoch >= epochs/2 and epoch%10 == 0:
                    self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/25-75/models/generator2N-{0}.h5'.format(epoch))
                    self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/25-75/models/discriminator2N-{0}.h5'.format(epoch))
