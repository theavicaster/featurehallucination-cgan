...
print(X_one.shape, X_two.shape , "50, 150 split")
...
modelinput1 = Input(shape=(15, 15, 50), name='Indian_Pines_Input_1')
modelinput2 = Input(shape=(15, 15, 150), name='Indian_Pines_Input_2')
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/25-75/twostream.h5', monitor='val_acc', verbose=1
