...
classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/90-10/twostream.h5')
...
generator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/90-10/generator.h5')
                                         #latent, conditional
...
(Xtrain_indian_pines, Xtest_indian_pines,Ytrain_indian_pine,Ytest_indian_pines,) = train_test_split(data,Y, random_state = 666, test_size=0.75)
