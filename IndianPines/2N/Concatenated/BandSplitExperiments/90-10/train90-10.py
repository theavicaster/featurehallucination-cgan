...
class GAN():
    def __init__(self):
        ...
        self.classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/90-10/twostream.h5')
    ...
    def train(self, epochs, batch_size=128):
        ...
        (Xtrain, _,_,_) = train_test_split(X_train,indian_pines_gt, random_state = 666, test_size = 0.75)
        ...
        X_train_one = X_train[:,:,:,0:180]
        X_train_two = X_train[:,:,:,180:200]
        ...
        for epoch in range(epochs):
            ...
            for g in range(5):
                ...
                if epoch >= epochs/2 and epoch%10 == 0:
                    self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/90-10/models/generator2N-{0}.h5'.format(epoch))
                    self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/90-10/models/discriminator2N-{0}.h5'.format(epoch))
