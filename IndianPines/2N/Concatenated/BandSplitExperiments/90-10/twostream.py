...
print(X_one.shape, X_two.shape , "180,20 split")
...
modelinput1 = Input(shape=(15, 15, 180), name='Indian_Pines_Input_1')
modelinput2 = Input(shape=(15, 15, 20), name='Indian_Pines_Input_2')
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/90-10/twostream.h5', monitor='val_acc', verbose=1
