...
combinedoutput = Lambda(lambda x: x / 1)(combinedoutput)
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T1/twostream.h5', monitor='val_acc', verbose=1
