...
class GAN():
    def __init__(self):
        ...
        self.classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T10/twostream.h5')
        ...
        for epoch in range(epochs):
            ...
            for g in range(5):
                ...
                if epoch >= epochs/2 and epoch%20==0:
                    #self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T10/models/generator2N-{0}.h5'.format(epoch))
                    #self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T10/models/discriminator2N-{0}.h5'.format(epoch))
                     ...
                     if results1[1]>topacc:
                          self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T10/generator.h5')
                          topacc = results1[1]
