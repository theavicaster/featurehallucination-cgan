...
print(X_one.shape, X_two.shape , "100,100 split")
...
#model = Model(inputs=[modelinput1,modelinput2], outputs=combinedoutput)
model = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/50-50/twostream.h5')
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/BandSplitExperiments/50-50/twostream.h5', monitor='val_acc', verbose=1
