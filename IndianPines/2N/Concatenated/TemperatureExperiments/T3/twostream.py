...
combinedoutput = Lambda(lambda x: x / 3)(combinedoutput)
...
print(model.summary())
sgd = optimizers.SGD(lr=0.00003, momentum=0.9, decay=1e-6)
model = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T3/twostream.h5')
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T3/twostream.h5', monitor='val_acc', verbose=1
