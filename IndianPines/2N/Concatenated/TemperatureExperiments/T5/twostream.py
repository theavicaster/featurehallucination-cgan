...
combinedoutput = Lambda(lambda x: x / 5)(combinedoutput)
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T5/twostreamcopy.h5', monitor='val_acc', verbose=1
