...
classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/10-90/twostream.h5')
...
#generator = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/2N/generator2N-{0}.h5'.format(x))
generator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/10-90/generator.h5')
                                         #latent, conditional
...
(Xtrain_indian_pines, Xtest_indian_pines,Ytrain_indian_pine,Ytest_indian_pines,) = train_test_split(data,Y, random_state = 666 , test_size=0.9)

(Xtrain_indian_pines1, Xtest_indian_pines1,Ytrain_indian_pine,Ytest_indian_pines,) = train_test_split(X_indian_pines1,Y, random_state = 666, test_size=0.9)
