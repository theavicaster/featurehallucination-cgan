...
(Xtrain_one, Xtest_one, Ytrain, Ytest) = train_test_split(X_one, Y, random_state = 666, test_size = 0.9)
(Xtrain_two, Xtest_two, Ytrain, Ytest) = train_test_split(X_two, Y, random_state = 666, test_size=0.9)
...
#model - load_model('/home/SharedData/Avinandan/Semi Supervised GAN/twostreamdistillation.h5')
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/10-90/twostreamdistillation.h5', monitor='val_acc', verbose=1
...
#model.save('/home/SharedData/Avinandan/Semi Supervised GAN/twostreamdistillation.h5')
