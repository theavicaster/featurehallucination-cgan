...
classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/twostreamdistillation.h5')
...
for x in range(4300,4400,1):

    generator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/models/generator2N-{0}.h5'.format(x))
    #generator = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/2N/generator2N.h5')
                                             #latent, conditional
