...
class GAN():
    def __init__(self):
        ...
        self.discriminator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/models/discriminator2N-4300.h5')
        ...
        self.generator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/models/generator2N-4300.h5')


        # Build the feature extractors
        self.classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/twostreamdistillation.h5')
    ...
    def train(self, epochs, batch_size=128):
        ...
        X_train, indian_pines_gt = loadIndianPinesData()
        #print(X_train)
        ...
        X_train, Y = createPatches(X_train, indian_pines_gt, windowSize=15)
        ...
        for epoch in range(4300,4400):
            ...
            for g in range(5):
                ...
                #if epoch%50 ==0 and epoch>=epochs/2:
                if 1:
                    self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/models/generator2N-{0}.h5'.format(epoch))
                    self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/models/discriminator2N-{0}.h5'.format(epoch))
