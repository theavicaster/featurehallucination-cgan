...
class GAN():
    def __init__(self):
        ...
        self.classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/twostream.h5')
    ...
    def train(self, epochs, batch_size=128):
        ...
        (X_train_one, X_test_one,Y,Y_test,) =    train_test_split(X_train_one,gt, random_state = 666 , test_size=0.5)

        (X_train_two, X_test_two,Y,Y_test,) =    train_test_split(X_train_two,gt, random_state = 666 , test_size=0.5)
                ...
                if epoch >= epochs/2 and epoch%20==0:
                    ...
                    #self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T1/models/discriminator2N-{0}.h5'.format(epoch))
                     ...
                     if results1[1]>topacc:
                          self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TrainTestExperiments/50-50/generator.h5')
                          topacc = results1[1]
