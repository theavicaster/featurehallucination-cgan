...
class GAN():
    def __init__(self):
        ...
        self.discriminator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T2/models/discriminator2N-5800.h5')
        ...
        self.generator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T2/models/generator2N-5800.h5')


        # Build the feature extractors
        self.classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T2/twostreamdistillation.h5')
    ...
    def train(self, epochs, batch_size=128):
        ...
        for epoch in range(5800,5900):
            ...
            for g in range(5):
                ...
                if 1:
                    self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T2/models/generator2N-{0}.h5'.format(epoch))
                    self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/IndianPines/2N/Concatenated/TemperatureExperiments/T2/models/discriminator2N-{0}.h5'.format(epoch))
