...
generator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/MultiModal/generatorone.h5')
#generator = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/2N/generator2N.h5')
                                         #latent, conditional
...
(Xtrain_MultiModal, Xtest_MultiModal,Ytrain_MultiModal,Ytest_MultiModal,) = train_test_split(data,Y, random_state = 666, test_size=0.75)
