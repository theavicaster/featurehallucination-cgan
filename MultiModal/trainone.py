...
class GAN():
    ...
    def train(self, epochs, batch_size=128):
        ...
        (X_train_one, X_test_one, Y, Ytest) = train_test_split(msdata, gt, random_state = 666, test_size= 0.75)
        (X_train_two, X_test_two, Y, Ytest) = train_test_split(pcdata, gt, random_state = 666, test_size = 0.75 )
        ...
        for epoch in range(epochs):
            ...
            for g in range(5):
                ...
                if epoch >= epochs/2:
                    #self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/MultiModal/models/generator-{0}.h5'.format(epoch))
                    #self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/MultiModal/models/discriminator-{0}.h5'.format(epoch))
...
'''
                     ...
                     if results1[1]>topacc:
                          self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/MultiModal/models/generatoronefinal.h5')
                          topacc = results1[1]
