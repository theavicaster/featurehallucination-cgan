...
classifier = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/PaviaUniv/2N/Concatenated/twostreamconcat.h5')
...
for x in range(4370,4410,1):
    ...
    generator = load_model('/home/SharedData/Avinandan/TeacherStudentExperiments/PaviaUniv/2N/Concatenated/models/generator-{0}.h5'.format(x))
    #generator = load_model('/home/SharedData/Avinandan/Semi Supervised GAN/2N/generator2N.h5')
                                             #latent, conditional
    ...
    (Xtrain_Pavia_Univ1, Xtest_Pavia_Univ1,Ytrain_Pavia_Univ,Ytest_Pavia_Univ,) = train_test_split(X_Pavia_Univ1,Y, random_state = 666)
