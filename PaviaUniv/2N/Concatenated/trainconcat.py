...
class GAN():
    ...
    def train(self, epochs, batch_size=128):
        ...
        X_train, Pavia_Univ_gt = loadData()
        #print(X_train)
        ...
        X_train, Y = createPatches(X_train, Pavia_Univ_gt, windowSize=15)
        ...
        for epoch in range(epochs):
            ...
            for g in range(5):
                ...
                if epoch >= epochs/2:
                    self.generator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/PaviaUniv/2N/Concatenated/models/generator-{0}.h5'.format(epoch))
                    self.discriminator.save('/home/SharedData/Avinandan/TeacherStudentExperiments/PaviaUniv/2N/Concatenated/models/discriminator-{0}.h5'.format(epoch))
