...
combinedoutput= Dense(9,activation='softmax', name='Classifier_Output')(combinedoutput)
...
checkpoint = ModelCheckpoint('/home/SharedData/Avinandan/TeacherStudentExperiments/PaviaUniv/2N/Concatenated/twostreamconcat.h5', monitor='val_acc', verbose=1
